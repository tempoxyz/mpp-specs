...
function main() {
	...
	console.log(`  2. Update apps/${appName}/README.md with:`)
	console.log(`     - What the app does (purpose, endpoints, free vs paid)`)
	console.log(`     - How to test it using the sample client`)
	console.log(`  3. pnpm --filter @tempo/${appName} dev`)
	console.log('')
