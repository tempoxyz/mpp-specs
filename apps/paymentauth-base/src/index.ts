...
function getFeeTokenAddress(env: Env): Address {
	return (env.FEE_TOKEN_ADDRESS as Address) ?? '0x036CbD53842c5426634e7929541eC2318f3dCF7e'
}
 ...
 */
async function confirmOnBase(txHash: Hex, rpcUrl: string): Promise<{ blockNumber: bigint | null }> {
	try {
