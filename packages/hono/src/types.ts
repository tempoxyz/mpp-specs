import type { ChargeRequest, PaymentReceipt } from '@ai-payments/protocol'
 ...
 */
export type PaymentVerifier = (signedTx: Hex, request: ChargeRequest) => Promise<VerificationResult>
 ...
 */
export type TransactionConfirmer = (txHash: Hex) => Promise<{ blockNumber: bigint | null }>
