import type { SignatureComponent, SignatureParameters, Algorithm } from './types'
...
function getSignAlgorithm(algorithm: Algorithm): AlgorithmIdentifier | RsaPssParams | EcdsaParams {
  switch (algorithm) {
    case 'ed25519':
      return { name: 'Ed25519' }
