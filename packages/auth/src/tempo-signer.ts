import type { Signer, SignerOptions } from './sign'
...
export class TempoSigner implements Signer {
  ...
  private getKeyAlgorithm(): AlgorithmIdentifier | RsaHashedImportParams | EcKeyImportParams {
  ...
  private getSignAlgorithm(): AlgorithmIdentifier | RsaPssParams | EcdsaParams {
    switch (this.algorithm) {
      case 'ed25519':
        return { name: 'Ed25519' }
      case 'ecdsa-p256-sha256':
