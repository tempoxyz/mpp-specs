...
authentication scheme {{PAYMENT-AUTH}}. It specifies how clients
...
The "Payment" HTTP authentication scheme {{PAYMENT-AUTH}} enables
...
- **Reference**: This document, {{well-known-endpoint}}
- **Status**: permanent
