...
test:
	docker run --rm -v "$$(pwd)":/data -w /data/scripts ietf-spec-tools pytest test_lint_frontmatter.py test_bump_and_rename.py test_gen_problems.py test_challenge_id_vectors.py -v
